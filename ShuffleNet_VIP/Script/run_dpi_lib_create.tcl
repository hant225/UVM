...
# Unset the default python3 (Environment Variables) in vivado lib to use the OS python
...
set_property -name {xsim.compile.xvlog.more_options} -value {-L uvm} -objects [get_filesets sim_conv1]
