...
#    - The image after preprocess and quantize is export as input for the CONVDW DUT	  
#-----------------------------------------------------------------------------------------
...
# conDW layer access
convDW = model.stage2[0].branch1[0]
...
with open("/home/hao/Documents/0.KHOA_LUAN_TOT_NGHIEP/shuffle_net/ShuffleNet_Evaluation/convDW_output/choosen_img.txt", "w") as image:
...
input_path = "/home/hao/Documents/0.KHOA_LUAN_TOT_NGHIEP/shuffle_net/ShuffleNet_VIP/InputData/convDW/"
output_path = "/home/hao/Documents/0.KHOA_LUAN_TOT_NGHIEP/shuffle_net/ShuffleNet_Evaluation/convDW_output/expected_results/"


def save_convDW_output(module, input, output):
...
# Register hook for convDW layer
convDW.register_forward_hook(save_convDW_output)
